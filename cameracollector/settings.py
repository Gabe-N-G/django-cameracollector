"""
Django settings for cameracollector project.
...
SECRET_KEY = 'django-insecure-s90j_ney0#07wo952+jv^m*r1#3oi1ff)vjlw8+cp7w+&k$!tg'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS =  ['localhost', '127.0.0.1'] # allows requests from localhost - will need to update again for deploy
...
ROOT_URLCONF = 'cameracollector.urls'
...
WSGI_APPLICATION = 'cameracollector.wsgi.application'
